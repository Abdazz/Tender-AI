...
class PDFProcessor:
    ...
    def _extract_with_docling(self, pdf_path: str) -> str:
        ...
        try:
            ...
            logger.error("Docling extraction failed", pdf_path=pdf_path, error=str(e))
            raise
    ...
    def _extract_with_pdfminer(self, pdf_path: str) -> str:
        ...
        try:
            ...
            logger.error("PDFMiner extraction failed", pdf_path=pdf_path, error=str(e))
            raise
    ...
    def get_pdf_info(self, pdf_path: str) -> dict[str, any]:
        ...
        try:
            ...
            logger.error("Failed to get PDF info", pdf_path=pdf_path, error=str(e))

        return info

    def validate_pdf(self, pdf_path: str) -> tuple[bool, str | None]:
        """Validate PDF file.
...
def validate_pdf_file(pdf_path: str) -> tuple[bool, str | None]:
    """Validate PDF file.
...
def extract_pdf_metadata(pdf_path: str) -> dict[str, str]:
    ...
    try:
        ...
        logger.error("Failed to extract PDF metadata", pdf_path=pdf_path, error=str(e))
