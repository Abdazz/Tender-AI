...
class MinIOClient:
    ...
    def ensure_bucket_exists(self) -> bool:
        ...
        try:
            ...
            if error_code == "404":
                ...
                logger.error(
                    "Failed to check bucket", bucket=self.bucket_name, error=str(e)
                )
                return False
    ...
    def put_object(
        ...
        try:
            ...
            self.client.upload_fileobj(
                data_io, self.bucket_name, key, ExtraArgs=extra_args
            )
    ...
    def cleanup_old_files(self, days_old: int = 30, prefix: str = "snapshots/") -> int:
        ...
        try:
            ...
            logger.error("Cleanup failed", prefix=prefix, error=str(e), exc_info=True)
            return 0
